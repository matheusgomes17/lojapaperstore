...
return [
    ...
    'backend' => [
        ...
        'catalog' => [
            ...
            'products' => [
                'delete_product_confirm'  => 'Tem certeza de que deseja excluir este produto permanentemente? Prossiga por sua conta e risco. Isso não pode ser desfeito.',
                'restore_product_confirm' => 'Restaurar esse produto ao seu estado original?',
            ],
        ],
        'dashboard' => [
        ...
        'general' => [
            ...
            'sliders' => [
                'delete_slider_confirm'  => 'Tem certeza de que deseja excluir este slider permanentemente? Prossiga por sua conta e risco. Isso não pode ser desfeito.',
                'restore_slider_confirm' => 'Restaurar esse slider ao seu estado original?',
            ],
        ],
        'search' => [
