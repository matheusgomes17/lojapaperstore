...
@section ('title', trans('labels.backend.general.sliders.management'))
...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.backend.general.sliders.active') }}</small>
    </h1>
@endsection
...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.general.sliders.active') }}</h3>
