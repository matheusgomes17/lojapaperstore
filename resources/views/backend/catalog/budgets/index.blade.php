...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.backend.catalog.budgets.pending') }}</small>
    </h1>
@endsection
...
<div class="box box-success">
    <div class="box-header with-border">
        <h3 class="box-title">{{ trans('labels.backend.catalog.budgets.pending') }}</h3>
...
<script>
    $(function() {
        $('#budgets-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{{ route("admin.catalog.budget.get") }}',
                type: 'post',
